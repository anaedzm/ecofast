...
const dist_folder = './dist/',
      ...
      node_dependencies  = Object.keys(pkgJson.devDependencies || {}),
...
// gulp.task('clear', () => del.deleteSync([ dist_folder ]));
...
gulp.task('fonts', () => {
  return gulp.src([ src_assets_folder + 'fonts/*.+(eot|ttf|woff|woff2)' ], { since: gulp.lastRun('fonts') })
...
gulp.task('build', gulp.series(
  //'clear', 
  'html', 'pug', 'sass', 'less', 'stylus', 'js', 'images', 'vendor', 'fonts'));
